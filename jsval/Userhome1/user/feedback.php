...
$qry="insert into tbl_feedback(userid,name,email,text,status) values('$uid','$name','$email','$feedback',1)";
$res=mysqli_query($con,$qry);
echo "<script>window.onload=function(){alert('Thanks For your feedback about the site....!');window.location='user_home.php';}</script>";
}
?>
<br><br>
...
/* //newsletter */
	...
	<footer class="py-5">
		<div style="padding:5px 100px;">
			...
			<h2 class="tittle text-wh mb-5 font-weight-bold"><font color="#000000">Enter your Feedback</font></h2>
			<br><br>
	...
	<script src="js/oh-autoval-script.js"></script>
				...
				<form   onsubmit="return" class="oh-autoval-form" method="post" >
						<div class="row">
							...
							<br>
							<div style="width:95%;">
								<textarea class="form-control av-name" type="text" name="feedback"  av-message="Please enter your feedback" placeholder="Please write here....." required="" style="height:200px; width:100%" ></textarea>
							</div>
							<br>
						</div>
						</br>
