...
<?php
include "../dbcon.php";
$results=mysqli_query($con,"SELECT * FROM  tbl_application as ad,addvacancy as va,userrregistration as us, where ad.vacancyid=va.vacancyid and va.vacancyid=us.Userid  ");
?>
<body>
<table border="1"
	<tr>
