...
<th><center>Name</center></th>
  ...
  <tr>
   ...
   <tr>
       <th><center>Vehicletype</center></th>
      <th><center><input type="text" disabled value="<?php echo $rest['Vehicletype'] ?>"></center></th>
  </tr>
  
  <tr>
       <th><center>Vehicle name</center></th>
      <th><center><input type="text" disabled value="<?php echo $rest['Vehiclename'] ?>"></center></th>
  </tr> 
   <tr>
       <th><center>Vehiclenumber</center></th>
      <th><center><input type="text" disabled value="<?php echo $rest['Vehiclenumber'] ?>"></center></th>
  </tr> 
 
   <tr>
       <th><center>Vehiclemodel</center></th>
      <th><center><input type="text" disabled value="<?php echo $rest['Vehiclemodel'] ?>"></center></th>
  </tr> 
