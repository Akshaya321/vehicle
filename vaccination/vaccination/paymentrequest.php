...
if (isset($_POST['submit'])) {
    ...
    echo $sql2 = "INSERT INTO `payment`(`Userid`,`Experience`,`Date`, `Amount`,status) VALUES ('$id','$e','$f','$g',1)";
    ...
    <br><br><br><br><br><br>
        ...
        <div class="item active" style="background-image: url(images/im2.jpg);">
            ...
            <table>
				...
				<tr><td>	<input type="submit" name="submit" value="Apply" class="form-control"></td></tr>
