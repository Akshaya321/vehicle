...
?>
                    ...
                    <tr><td>Percentage:</td>
					<td>
						<input type="text"  name="percentage" class="form-control"style="width:250px;"required/></td></tr>
						<i class="zmdi zmdi-lock"></i>
					</div>
					<div class="form-wrapper">
                    <tr><td>Certificate:</td>
					<td>
						<input type="file"  name="certificate" class="form-control"style="width:250px;"required/></td></tr>
						<i class="zmdi zmdi-lock"></i>
                    </div>
