						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li id="menu-academico" ><a href="Addqualification.php"><i class="fa fa-map-marker"></i>  <span>Addqualification</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										 
									 </li>
										 
										 
										 
										 <li id="menu-academico" ><a href="view.php"><i class="fa fa-map-marker"></i>  <span>View Companydetails</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										 
									 </li>
										 
										  <li id="menu-academico" ><a href="viewex1.php"><i class="fa fa-map-marker"></i>  <span>View Exchangedetails</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										
									
							        <li id="menu-academico" ><a href="view4.php"><i class="fa fa-file-text-o"></i>  <span>View Vacancies</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
