                           ...
                           <div class="menu">
									<ul id="menu" >
										...
										<li id="menu-academico" ><a href="viewuserdetails.php"><i class="fa fa-map-marker"></i>  <span>Profile</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										 ...
										 <li id="menu-academico" ><a href="view.php"><i class="fa fa-map-marker"></i>  <span>View Healthdetails</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
									...
									<li><a href="Apply.php"><i class="fa fa-gears nav_icon"></i><span>Make Appointment</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
									  </li>
