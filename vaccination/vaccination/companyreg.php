...
if($row=mysqli_fetch_array($result2))
{
  ...
  $l=$row["login_id"];
 $sql2="INSERT INTO `companyreg`(`comregid`,`Healthname`,`Sector`,`Regno`,`Location`,`postid`,`Phone`, `status`) VALUES 
 ('$l','$b','$c','$d','$e','$f','$g',1)";
  echo $sql2;    
			...
			<div class="image-holder">
				...
				<form action="#" method="post" enctype="multipart/form-data" class="oh-autoval" style="border:solid 2px #000;width:400px;">
					...
					<div class="col-sm-3 col-md-2 col-5">
                                               <label style="font-weight:bold;">Healthcenter Name</label>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                <input  type="text" name="Healthname"style="width:330px;" class="av-username" av-message="wrong">
                                            </div>
					...
					<div class="col-sm-3 col-md-2 col-5">
                                            ...
                                            <div class="col-md-8 col-6">
                                                ...
                                                <input  type="text" name="Sector"style="width:330px;"  required/>
                                            </div>
                                            ...
                                            <div class="col-md-8 col-6">
                                                <input  type="number" name="Regno"style="width:330px;"class="av-mobile">
											</div>
											<div class="col-sm-3 col-md-2 col-5">
                                            ...
                                            <div class="col-md-8 col-6">
                                                ...
                                                <input  type="text" name="Location"style="width:330px;" max="1999-12-31" required/>
                                            </div>
