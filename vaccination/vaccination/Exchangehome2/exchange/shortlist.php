...
$qry="insert into tbl_short(user_id,name,email,message,status) values('$uid','$name','$email','$text',1)";
$res=mysqli_query($con,$qry);
echo "<script>window.onload=function(){alert('Sending message....!');window.location='view10.php';}</script>";
}
?>
<br><br>
...
/* //newsletter */
	...
	<footer class="py-5">
		<div style="padding:5px 100px;">
			...
			<h2 class="tittle text-wh mb-5 font-weight-bold"><font color="#000000">Send your message</font></h2>
			<br><br>
