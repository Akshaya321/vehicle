...
$sql="insert into apprej(appid,name,text,status) values('$e','$a','$c',1)";
$res=mysqli_query($con,$sql);
echo "<script>window.onload=function(){alert('Send Response....!');window.location='Company_home.php';}</script>";
}
?>
<br><br>
...
/* //newsletter */
	...
	<footer class="py-5">
		<div style="padding:5px 100px;">
			...
			<h2 class="tittle text-wh mb-5 font-weight-bold"><font color="#ffff00">Enter Response</font></h2>
			<br><br>
	...
	<script src="js/oh-autoval-script.js"></script>
				...
				<form   onsubmit="return" class="oh-autoval-form" method="post" >
						<div class="row">
							<div style="width:95%;">
								<input class="form-control av-name" type="text" name="name"  placeholder="Name" ">
							</div>
							<br>
							
							<div style="width:95%;">
								<textarea class="form-control av-name" type="text" name="text"  av-message="Please enter your feedback" placeholder="Please write here....." required="" style="height:200px; width:100%" ></textarea>
							</div>
							<br>
						</div>
						</br>
