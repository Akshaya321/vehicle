...
//  move_uploaded_file($_FILES['photo']['tm_name'],$photo);
 ...
 echo $update="update `companyreg` set `Name`='$a',`Address`='$b',`Place`='$c',`Phone`='$d', where comregid=$id";
...
?>
             ...
             $qry="select * from companyreg where comregid=$logid";
     ...
     $Place=$rest['Place'];
      $Phone=$rest['Phone'];
           ...
           <tr><td><input type="hidden" value="<?php echo $rest['comregid'];?>" name="id"></label></td></tr>                                      
